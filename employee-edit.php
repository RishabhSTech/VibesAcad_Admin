...
$sqlObj = new Actions();
 ...
 if (isset($_POST['submit'])) {
    ...
    if($password != ''){
	    $sql = "UPDATE admin_users SET name = '".$name."', caller_id = '".$caller_id."', username  = '".$username."', password = '".$password."', role = '".$role."' WHERE id = '".$_GET['id']."'";
    }else{
        $sql = "UPDATE admin_users SET name = '".$name."', caller_id = '".$caller_id."', username  = '".$username."', role = '".$role."' WHERE id = '".$_GET['id']."'";
    }
...
if(!empty($_GET['id']) && $_GET['id']) {
	$emp_data = $sqlObj->getEmployeedata($_GET['id']);		
...
<body>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-6">
				<H4 class="mb-5 mt-5">Edit Employee</H4>
				<form action="" method="POST">
					...
					<div class="d-grid gap-2 mt-5">
						...
						<input class="btn btn-primry MainColor text-white" type="submit" name="submit" value="Update Employee Data">
					</div>
				</form>
			</div>
		</div>
